...
# -*- coding: utf-8 -*-
"""
This module contains PyQt4 assignment functions that were designed to support the standardized widgets found in pyqtauto.widgets. 
...
def set_uniform_margins(widget, margin):
	...
	Parameters
	----------
	widget : QWidget or subclass, QLayout subclass
	margin : int
